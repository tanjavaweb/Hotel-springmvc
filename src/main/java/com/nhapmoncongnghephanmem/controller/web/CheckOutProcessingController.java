...
public class CheckOutProcessingController {
	...
	@PostMapping
	public void receiveCheckOutRequest(HttpServletRequest request, HttpServletResponse response)
	...
	@GetMapping
	public void handeCheckOut(HttpServletRequest request, HttpServletResponse response) {
	...
	private void sendVertificationEmail(String randomCode, String email)
		...
		msg.setText("Please click The link below to vertify your email."
				+ "https://https://chuyendeweb.herokuapp.com/checkOutProcessing?code=" + randomCode);
